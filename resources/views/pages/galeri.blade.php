...
<section class="program-hero position-relative d-flex align-items-center justify-content-center text-center"
         style="background-image: url('{{ asset('img/galeri-img.jpg') }}');">
    ...
    <div class="container position-relative z-2">
        ...
        <h1 class="display-3 fw-bold text-white mb-3" data-aos="fade-up">
            {!! __('Galeri <span class="text-gradient-blue">Aktivitas</span>') !!}
        </h1>
        <p class="lead text-white-50 mx-auto" style="max-width: 700px;" data-aos="fade-up" data-aos-delay="100">
            {{ __('Intip keseruan belajar, kompetisi, dan momen berharga para siswa Beta Badri Education.') }}
        </p>
    </div>
</section>

{{-- ========================================== --}}
{{-- 2. FILTER & GRID GALERI --}}
{{-- ========================================== --}}
    ...
    <div class="container py-5 position-relative z-2">
        ...
        <div class="row justify-content-center mb-5" data-aos="fade-up">
            <div class="col-md-10 text-center">
                <p class="text-white-50 mb-3 small">{{ __('Pilih kategori di bawah untuk menampilkan foto:') }}</p>
                <div class="filter-group d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <a href="{{ route('public.gallery') }}"
                       class="btn btn-filter {{ !request()->has('category') || request('category') == 'all' ? 'active' : '' }}">
                        <i class="fas fa-layer-group me-2"></i> {{ __('Tampilkan Semua') }}
                    </a>
        ...
        <div class="row g-4" data-aos="fade-up">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="gallery-card">
                    ...
                    {{-- Gambar Thumbnail --}}
                    {{-- Pastikan path 'storage/' sudah benar dan symlink sudah dibuat (php artisan storage:link) --}}
                    ...
                    <div class="gallery-overlay">
                        ...
                        {{-- PEMICU MODAL GAMBAR --}}
                        {{-- Pastikan data-image terisi dengan URL yang benar --}}
            ...
            <div class="col-12 text-center py-5">
                ...
                <p class="text-white-50 fs-5">{{ __('Belum ada foto di kategori ini.') }}</p>
            </div>
            @endforelse
        </div>
        ...
        <div class="d-flex flex-column align-items-center mt-5 pt-4 border-top border-secondary">
            <div class="text-secondary small mb-3">
                {{ __('Menampilkan') }} <span class="fw-bold text-white">{{ $galleries->firstItem() }}</span>
                {{ __('sampai') }} <span class="fw-bold text-white">{{ $galleries->lastItem() }}</span>
                {{ __('dari') }} <span class="fw-bold text-white">{{ $galleries->total() }}</span> {{ __('hasil') }}
            </div>
